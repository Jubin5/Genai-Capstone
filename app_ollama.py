...
Using Ollama Phi model instead of Google Gemini
"""
...
# --------- Streamlit App ---------
st.set_page_config(page_title="AI Contract & Policy Simplifier (Ollama Phi)", layout="wide")
...
if uploaded_file:
    ...
    st.subheader("Processing with Ollama Phi Model...")
    summaries = []
